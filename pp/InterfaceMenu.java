...
public class InterfaceMenu extends InterfaceBase {
     ...
     * @since 1.0
     */
	public InterfaceMenu(GestionnaireInterfacePP gi) { 
		super();
...
//-----------------Créations des composants------------------------------------------------  
		...
		boutonJouer.setOnAction(e -> {
			GI.afficherEcran(GI.InterfaceMap.get("CreerPartie"));}); // switch Pane visibility
		...
		boutonLangue.setOnAction(e -> {
			GI.langueSelectionne = (GI.langueSelectionne == "Français") ?  "English" :  "Français";
